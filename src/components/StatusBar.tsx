...
function getStatus(isListening: boolean, error: string | null): Status {
...
export default function StatusBar({ isListening, error, language, onLanguageChange }: StatusBarProps) {
  const status = getStatus(isListening, error)
  ...
  return (
    ...
    >
      ...
      {/* Right: language selector + branding */}
